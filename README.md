...
|2023.10.23|이론 정리 및 발표, 질의응답, AI경진대회 예선 준비|합성곱 신경망(CNN)에 대한 학습 내용을 정리하여 발표하였고 서로 질의응답을 하였음, 데이터 분석 연습을 하며 국방 AI 경진대회를 준비하는 시간을 가짐 (부스팅 모델을 이용한 정형데이터 회귀)|
|2023.10.31|DACON 경진대회 참여 및 vision 논문 발표|DACON 제주 특산물 가격 예측 경진대회의 EDA 및 모델 선정, vgg 논문 리뷰|
|2023.11.08|DACON 경진대회|역할 분담 (품목별 부스팅 모델의 성능평가 지표 비교 / 딥러닝 모델 사용 환경 세팅)|
